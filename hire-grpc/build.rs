...
//   packaged hire-grpc would fail here with a missing-file error that says
//   nothing about packaging | upgrade path: `git mv proto hire-grpc/proto`
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // outside hire-grpc/, so they are not in that set: editing one and
