...
pub struct WitsvidResponse {
    ...
    #[prost(message, repeated, tag = "1")]
    pub svids: ::prost::alloc::vec::Vec<Witsvid>,
}
...
pub struct Witsvid {
    ...
    #[prost(string, tag = "2")]
    pub wit_svid: ::prost::alloc::string::String,
    /// Required. JWK-encoded private key bound to this WIT-SVID.
    #[prost(string, tag = "3")]
    pub wit_svid_key: ::prost::alloc::string::String,
...
pub mod spiffe_workload_api_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        /// the server.
        pub async fn fetch_witsvid(
            &mut self,
            request: impl tonic::IntoRequest<super::WitsvidRequest>,
        ) -> std::result::Result<
            tonic::Response<tonic::codec::Streaming<super::WitsvidResponse>>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("SpiffeWorkloadAPI", "FetchWITSVID"));
            self.inner.server_streaming(req, path, codec).await
        }
        ...
        pub async fn fetch_wit_bundles(
            &mut self,
            request: impl tonic::IntoRequest<super::WitBundlesRequest>,
        ) -> std::result::Result<
            tonic::Response<tonic::codec::Streaming<super::WitBundlesResponse>>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("SpiffeWorkloadAPI", "FetchWITBundles"));
            self.inner.server_streaming(req, path, codec).await
        }
    }
}
...
pub mod spiffe_workload_api_server {
    ...
    pub trait SpiffeWorkloadApi: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn validate_jwtsvid(
            ...
            tonic::Status,
        >;
        /// Server streaming response type for the FetchWITSVID method.
        type FetchWITSVIDStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::WitsvidResponse, tonic::Status>,
            >
            + std::marker::Send
            + 'static;
        /// Fetch WIT-SVIDs for all SPIFFE identities the workload is entitled to.
        ...
        async fn fetch_witsvid(
            &self,
            request: tonic::Request<super::WitsvidRequest>,
        ) -> std::result::Result<
            tonic::Response<Self::FetchWITSVIDStream>,
            tonic::Status,
        >;
        /// Server streaming response type for the FetchWITBundles method.
        type FetchWITBundlesStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::WitBundlesResponse, tonic::Status>,
            >
            + std::marker::Send
            + 'static;
        /// Fetch WIT bundles, formatted as JWKS documents, keyed by the SPIFFE ID
        ...
        async fn fetch_wit_bundles(
            &self,
            request: tonic::Request<super::WitBundlesRequest>,
        ) -> std::result::Result<
            tonic::Response<Self::FetchWITBundlesStream>,
            tonic::Status,
        >;
    }
    #[derive(Debug)]
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/SpiffeWorkloadAPI/FetchWITSVID" => {
                    #[allow(non_camel_case_types)]
                    struct FetchWITSVIDSvc<T: SpiffeWorkloadApi>(pub Arc<T>);
                    impl<
                        T: SpiffeWorkloadApi,
                    > tonic::server::ServerStreamingService<super::WitsvidRequest>
                    for FetchWITSVIDSvc<T> {
                        type Response = super::WitsvidResponse;
                        type ResponseStream = T::FetchWITSVIDStream;
                        type Future = BoxFuture<
                            tonic::Response<Self::ResponseStream>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SpiffeWorkloadApi>::fetch_witsvid(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = FetchWITSVIDSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/SpiffeWorkloadAPI/FetchWITBundles" => {
                    #[allow(non_camel_case_types)]
                    struct FetchWITBundlesSvc<T: SpiffeWorkloadApi>(pub Arc<T>);
                    impl<
                        T: SpiffeWorkloadApi,
                    > tonic::server::ServerStreamingService<super::WitBundlesRequest>
                    for FetchWITBundlesSvc<T> {
                        type Response = super::WitBundlesResponse;
                        type ResponseStream = T::FetchWITBundlesStream;
                        type Future = BoxFuture<
                            tonic::Response<Self::ResponseStream>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SpiffeWorkloadApi>::fetch_wit_bundles(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = FetchWITBundlesSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
