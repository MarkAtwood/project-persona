...
use persona_attestors::{Candidate, ChallengeSignature, Evidence, SelfAssertedDomain};
...
/// doubles now exercise the same path a live agent does. Before persona-5s4b.116
