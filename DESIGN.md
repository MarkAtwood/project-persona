...
Register `personad` as a FedCM identity provider. The browser handles the trust UI; web pages call the FedCM API without a custom extension. Timeline: months to years, depending on how fast FedCM standardizes.
