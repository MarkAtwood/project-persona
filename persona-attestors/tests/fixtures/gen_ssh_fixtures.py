#!/usr/bin/env python3
"""Generate the SSH-shaped ed25519 fixtures used by persona-attestors/src/claim.rs.

Two independent oracles, neither of which is persona:
...
OK and persona must say Err is therefore correct, not a disagreement to fix.
"""
...
def fingerprint(key_blob: bytes) -> str:
    ...
    Computed here with hashlib and base64, independently of persona's
